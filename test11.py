...
# Run the "dir" command to list files in the current directory
result = subprocess.run(['start /B test11.exe'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
